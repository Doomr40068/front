export function Vacantion() {
    return (
        <div className="!mt-[120px] !pt-[20px] !px-[80px] h-[600px] items-center gap-[20] text-white flex flex-col rounded-4xl bg-gradient-to-t from-[#060B82] to-[#0B0D20]">
            ...
            <div className="flex">
                ...
                <div className="w-[50%] flex flex-col gap-5">
                    ...
                    <div className="flex text-[12px] font-['Wix_Madefor_Text'] font-light gap-2 items-center ">
                        <button className="text-[14px] rounded-[25px] font-['Wix_Madefor_Text'] !py-2 !px-4.5 bg-blue-600 !px-[35px]">
                            Присоединяйся
                        </button>
